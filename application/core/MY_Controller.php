...
class MY_Controller extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->update_link        = 'http://hexacrew.co/';
        $this->portal_update_link = 'http://hexacrew.co/';
        $this->bug_tracker_link   = 'http://hexacrew.co/';

        # load helper
        $this->load->helper(array('url', 'form', 'text', 'elearning', 'security', 'file', 'number', 'date', 'download', 'plugins'));

        $error_install = "Install aplikasi e-learning by HexaCrew (http://hexacrew.co): " . anchor('setup', "&rarr; Halaman Install");
        try {
            check_db_connection();
        } catch (Exception $e) {
    ...
    /**
     * Method untuk mengambil informasi yang urgent dari hexacrew.co
     *
    ...
    function check_urgent_info($skip_check_time = false)
    {
        ...
        if ($ok_check) {
            $url_urgent_info = "http://hexacrew.co";
