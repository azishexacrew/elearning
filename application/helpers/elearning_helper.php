...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => 'Copyright &copy;' . date('Y') . 'HexaCrew <a href="http://hexacrew.co">hexacrew.co</a>',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy;' . date('Y') . ' ' . get_pengaturan('nama-sekolah', 'value').' by HexaCrew - <a href="http://hexacrew.co">hexacrew.co</a>';
        $return['site_name'] = 'e-Learning '.get_pengaturan('nama-sekolah', 'value');
        $return['version']   = 'versi 1.0';
